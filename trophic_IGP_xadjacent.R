...
# trophic IGP spatially explicit model
# non-random habitat resotration - x-adjacent method
#                                - sites adjecent to occupied by resource restored first, 
#                                  then sites adjecent to occupied by consumer restored,
#                                  then sites adjecent to occupied by predator restored, 
#                                  then empty restored
# species:
# x - resource
# y - consumer
...
mu4 <- 0.35       # probablilty of consumer 2 extinction due to consumer 1 presence
mu5 <- 0.35       # probablilty of consumer 2 extinction due to predator presence
psi1 <- 0.4       # probablilty of consumer 1 extinction due lack of resource
psi2 <- 0.4       # probablilty of consumer 1 extinction due lack of consumer 1
psi3 <- 0.2       # probablilty of consumer 2 extinction due lack of resource
psi4 <- 0.4       # probablilty of predator extinction due lack of consumer 1
psi5 <- 0.4       # probablilty of predator extinction due lack of consumer 2
...
dynamicsD <- function(cx, cy1, cy2, cz, ex, ey1, ey2, ez, mu1, mu2, mu3, mu4, mu5, psi1, psi2, psi3, psi4, psi5, 
  ...
  EY11 <- c((ey1+psi1/2+psi2/2), (ey1+psi2/2), (1-ey1-psi1/2-psi2/2), (ey1+psi1/2+psi2/2), 
            (ey1+psi1/2+psi2/2), (1-ey1-psi2/2), (ey1+psi2/2), (ey1+psi2/2), 
            (1-ey1-psi1/2-psi2/2), (1-ey1-psi1/2-psi2/2), (ey1+psi1/2+psi2/2), (1-ey1-psi2/2), 
            (1-ey1-psi2/2), (ey1+psi2/2), (1-ey1-psi1/2-psi2/2), (1-ey1-psi2/2))
  EY12 <- c((ey1+psi1/2), ey1, (1-ey1-psi1/2), (ey1+psi1/2), (ey1+psi1/2), (1-ey1), ey1, ey1, 
            (1-ey1-psi1/2), (1-ey1-psi1/2), (ey1+psi1/2), (1-ey1), (1-ey1), ey1, (1-ey1-psi1/2), (1-ey1))
  EY13 <- c((ey1+psi1/2+psi2/2+mu3), (ey1+psi2/2+mu3), (1-ey1-psi1/2-psi2/2-mu3), (ey1+psi1/2+psi2/2+mu3), 
            (ey1+psi1/2+psi2/2+mu3), (1-ey1-psi2/2-mu3), (ey1+psi2/2+mu3), (ey1+psi2/2+mu3), 
            (1-ey1-psi1/2-psi2/2-mu3), (1-ey1-psi1/2-psi2/2-mu3), (ey1+psi1/2+psi2/2+mu3), (1-ey1-psi2/2-mu3), 
            (1-ey1-psi2/2-mu3), (ey1+psi2/2+mu3), (1-ey1-psi1/2-psi2/2-mu3), (1-ey1-psi2/2-mu3))
  EY14 <- c((ey1+psi1/2+mu3), (ey1+mu3), (1-ey1-psi1/2-mu3), (ey1+psi1/2+mu3), 
            (ey1+psi1/2+mu3), (1-ey1-mu3), (ey1+mu3), (ey1+mu3), 
            (1-ey1-psi1/2-mu3), (1-ey1-psi1/2-mu3), (ey1+psi1/2+mu3), (1-ey1-mu3), 
            (1-ey1-mu3), (ey1+mu3), (1-ey1-psi1/2-mu3), (1-ey1-mu3))
  EY21 <- c((ey2+psi3), ey2, (ey2+psi3+mu4), (1-ey2-psi3), (ey2+psi3), (ey2+mu4), (1-ey2), ey2, 
            (1-ey2-psi3-mu4), (ey2+psi3+mu4), (1-ey2-psi3), (1-ey2-mu4), (ey2+mu4), (1-ey2), (1-ey2-psi3-mu4), (1-ey2-mu4))
  EY22 <- c((ey2+psi3+mu5), (ey2+mu5), (ey2+psi3+mu4+mu5), (1-ey2-psi3-mu5), 
            (ey2+psi3+mu5), (ey2+mu4+mu5), (1-ey2-mu5), (ey2+mu5), 
            (1-ey2-psi3-mu4-mu5), (ey2+psi3+mu4+mu5), (1-ey2-psi3-mu5), (1-ey2-mu4-mu5), 
            (ey2+mu4+mu5), (1-ey2-mu5), (1-ey2-psi3-mu4-mu5), (1-ey2-mu4-mu5))
  EZ  <- c((ez+psi4/2+psi5/2), (ez+psi4/2+psi5/2), (ez+psi5/2), (ez+psi4/2), 
           (1-ez-psi4/2-psi5/2), (ez+psi5/2), (ez+psi4/2), (1-ez-psi4/2-psi5/2), 
           ez, (1-ez-psi5/2), (1-ez-psi4/2), ez, 
           (1-ez-psi5/2), (1-ez-psi4/2), (1-ez), (1-ez))
      ...
      for(i in 1:n){
        for(j in 1:n){
          ...
          if(xt[i,j,g-1]==-1) { xt[i,j,g] <- -1 }    # destroyed sites remain destroyed
            ...
            for(h in 1:16){ pt[h] <- CX[h] * EY12[h] * EY21[h] * CZ[h] }  # transition probabilities from state 8 to state x
            ...
            for(h in 1:16){ pt[h] <- CX[h] * EY13[h] * CY2[h] * EZ[h] }  # transition probabilities from state 9 to state x
            ...
            for(h in 1:16){ pt[h] <- EX4[h] * EY12[h] * EY21[h] * CZ[h] }  # transition probabilities from state 11 to state x
            ...
            for(h in 1:16){ pt[h] <- EX2[h] * EY13[h] * CY2[h] * EZ[h] }  # transition probabilities from state 12 to state x
            ...
            for(h in 1:16){ pt[h] <- CX[h] * EY14[h] * EY22[h] * EZ[h] }  # transition probabilities from state 14 to state x
            ...
            for(h in 1:16){ pt[h] <- EX4[h] * EY14[h] * EY22[h] * EZ[h] }  # transition probabilities from state 15 to state x
...
outD <- dynamicsD(cx, cy1, cy2, cz, ex, ey1, ey2, ez, mu1, mu2, mu3, mu4, mu5, psi1, psi2, psi3, psi4, psi5, 
                  px0, py10, py20, pz0, n, tmax, dD)
...
dynamicsR <- function(cx, cy1, cy2, cz, ex, ey1, ey2, ez, mu1, mu2, mu3, mu4, mu5, psi1, psi2, psi3, psi4, psi5, 
                      tmax, DR, dR) {
  ...
  for(k in 2:length(r)){
      ...
      for(j in 1:n){
        ...
        if(xreq[i,j,k]!=-1) { next }
          ...
          for(h in 1:4){
            ...
            if(i_n < 1 || i_n > n || j_n < 1 || j_n > n) { next } # neighbour outside of grid
            if(xreq[i_n,j_n,k]==1 || xreq[i_n,j_n,k]==5 || xreq[i_n,j_n,k]==6 || xreq[i_n,j_n,k]==7 || 
               xreq[i_n,j_n,k]==11 || xreq[i_n,j_n,k]==12 || xreq[i_n,j_n,k]==13 || xreq[i_n,j_n,k]==15) {
              n_x <- n_x+1
              d_x[n_x,1] <- i
              d_x[n_x,2] <- j
              n1 <- 1
              break }               # if neighbour occupied by x, move to next patch
            else if(xreq[i_n,j_n,k]==2 || xreq[i_n,j_n,k]==8 || xreq[i_n,j_n,k]==9 || xreq[i_n,j_n,k]==14) {
              n2 <- 1 }
            else if(xreq[i_n,j_n,k]==3 || xreq[i_n,j_n,k]==10) {
              n3 <- 1 }
            else if(xreq[i_n,j_n,k]==4) {
              n4 <- 1 }
          }
          if(n1==0 && n2==1) {
            n_y1 <- n_y1+1
    ...
    # restore patches adjecent to x-occupied patches only
    if(n_x>=dn) {
      rp <- sample(1:n_x,dn)
      for(h in 1:dn) {
        i_d <- d_x[rp[h],1]
    ...
    # restore patches adjecent to x-occupied patches first, then y1-occupied, then y2-occupied, then z-occupied, then empty
    if(n_x<dn) {
      if(n_x>0) {
        for(h in 1:n_x) {
          i_d <- d_x[h,1]
      ...
      if(n_y1>=(dn-n_x)) {
        ...
        if(n_y2>=(dn-n_x-n_y1)) {
          rp <- sample(1:n_y2,(dn-n_x-n_y1))
          for(h in 1:(dn-n_x-n_y1)) {
            i_d <- d_y2[rp[h],1]
            j_d <- d_y2[rp[h],2]
            xreq[i_d,j_d,k] <- 0
          }
        }
        else if(n_y2<(dn-n_x-n_y1)) {
          if(n_y2>0) {
            for(h in 1:n_y2) {
              i_d <- d_y2[h,1]
              j_d <- d_y2[h,2]
          ...
          if(n_z>=(dn-n_x-n_y1-n_y2)) {
            rp <- sample(1:n_z,(dn-n_x-n_y1-n_y2))
            for(h in 1:(dn-n_x-n_y1-n_y2)) {
              i_d <- d_z[rp[h],1]
              j_d <- d_z[rp[h],2]
              xreq[i_d,j_d,k] <- 0
            }
          }
          else if(n_z<(dn-n_x-n_y1-n_y2)) {
            if(n_z>0) {
              for(h in 1:n_z) {
                i_d <- d_z[h,1]
                j_d <- d_z[h,2]
            ...
            rp <- sample(1:n_e,(dn-n_x-n_y1-n_y2-n_z))
            for(h in 1:(dn-n_x-n_y1-n_y2-n_z)) {
              i_d <- d_e[rp[h],1]
              j_d <- d_e[rp[h],2]
              xreq[i_d,j_d,k] <- 0
            }
...
outR <- dynamicsR(cx, cy1, cy2, cz, ex, ey1, ey2, ez, mu1, mu2, mu3, mu4, mu5, psi1, psi2, psi3, psi4, psi5, 
                  tmax, DR, dR)
